...
class DataPreprocessor:
    ...
    def load_datasets(self):
        ...
        if balanced_path.exists():
            ...
            print(f"[OK] Loaded balanced dataset: {len(datasets['balanced'])} rows")
        ...
        if negative_path.exists():
            ...
            print(f"[OK] Loaded negative dataset: {len(datasets['negative'])} rows")
        
        # Cleaned dataset
        cleaned_path = self.data_dir / "cleaned_hotel_reviews.csv"
        if cleaned_path.exists():
            datasets['cleaned'] = pd.read_csv(cleaned_path)
            print(f"[OK] Loaded cleaned dataset: {len(datasets['cleaned'])} rows")
        ...
        if syn_action_path.exists():
            ...
            print(f"[OK] Loaded synthetic action dataset: {len(datasets['synthetic_actions'])} rows")
